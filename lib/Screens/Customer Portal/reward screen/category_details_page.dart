...
class CategoryDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final categoryDeController = Get.put(CategoryDetailsController(
        productId: productId, clientId: clientId, clientName: clientName));
    final cartController = Get.put(CartController());

    return CommonAppbar(
      onTap: () async {
        SharedPreferences preferences = await SharedPreferences.getInstance();
        preferences.setInt("BackFlag", 3);
        Get.to(CartPage(
          clientId: clientId,
      ...
      bottomNavigationBar: isBool == true
          ? Obx(
              () => ElevatedButton(
